...
class ParallelReadersSpec extends FlatSpec {


val schUrn = CtsUrn("urn:cts:greekLit:tlg5026.msAint.hmt_xml:1.32.comment")
val abbreviatedText = """<div n="comment" xmlns="http://www.tei-c.org/ns/1.0" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl"> <p>δέχθαι ἄποινα ἀπαρέμφατον ἀντὶ <choice> <abbr>προστ</abbr> <expan>προστακτικοῦ</expan> </choice> ἰστέον ὅτι τὸ παλαιὸν ἡ <placeName n="urn:cite2:hmt:place.r1:place36">Πελοπόννησος</placeName> εἰς <num value="5">ε</num> διηπεῖτο μοίρας·

<placeName n="urn:cite2:hmt:place.r1:place40">Αργολικὴν</placeName> <placeName n="urn:cite2:hmt:place.r1:place41">Πυλικὴν</placeName> <placeName n="urn:cite2:hmt:place.r1:place53">Λακονικὴν</placeName> <placeName n="urn:cite2:hmt:place.r1:place42">Μεσσηνιακήν</placeName>·

ἰστεον δὲ ὅτι ἡ <placeName n="urn:cite2:hmt:place.r1:place36">Πελοπόννησος</placeName> τὸ <choice> <abbr>αρχ</abbr> <expan>αρχαῖον</expan> </choice> <placeName n="urn:cite2:hmt:place.r1:place43">Αιγιάλεια</placeName> ἐκαλειτο απὸ <persName n="urn:cite2:hmt:pers.r1:pers120">Αιγιαλέως</persName> <unclear>τοῦ υἱοῦ</unclear> <persName n="urn:cite2:hmt:pers.r1:pers121">Ἰνάχου</persName> τοῦ ἐν <placeName n="urn:cite2:hmt:place.r1:place44">Ἄργει</placeName> ποταμοῦ καὶ <persName n="urn:cite2:hmt:pers.r1:pers122">Μελείας</persName> τῆς <persName n="urn:cite2:hmt:pers.r1:pers123">Ωκεανοῦ</persName>.⁑</p> </div>"""





  val abbreviatedNode = CitableNode(schUrn,abbreviatedText.replaceAll("\n",""))
  "The Reader objects" should "write diplomatic for a citable node" in {
    ...
    val diplNode = DiplomaticReader.editedNode(abbreviatedNode)
    val scribalNode = ScriballyNormalizedReader.editedNode(abbreviatedNode)
    val editorialNode = EditoriallyNormalizedReader.editedNode(abbreviatedNode)


    println("SOURCE:")
    println(abbreviatedNode.text + "\n")
