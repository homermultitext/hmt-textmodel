...
class ReadingSpec extends FlatSpec {
  ...
  it should "use square bracket for restorations in leiden convention stringification" in  pending /*{
  ...
  it should "use the unaltered reading value for clear characters in leiden convention stringification" in  pending /*{
